...
export const ThemeProvider = ({ children }: { children: ReactNode }) => {
  ...
  useEffect(() => {
    document.documentElement.classList.remove("classic", "navy", "jerusalem", "bordeaux", "forest", "sand", "night", "royal-gold", "elegant-night", "ancient-scroll", "light", "gold-silver", "torah-luxury", "pearl-gold", "parchment-navy", "midnight-gold", "custom");
