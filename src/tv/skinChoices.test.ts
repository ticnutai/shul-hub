 ...
 * config and never appear in the picker - it happened. This reads the
 * picker's source rather than importing it (it is a .tsx with JSX previews)
 * and checks the two lists match, with no repeats.
 */
describe("skin picker", () => {
  const source = readFileSync("src/community/components/admin/tv/tvChoices.tsx", "utf8");
